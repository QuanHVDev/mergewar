...
namespace CodeMonkey.CraftingSystem {
    ...
    public class CraftingSystem : IItemHolder {
        ...
        public CraftingSystem(List<RecipeScriptableObject> recipeScriptableObjectList) {
            ...
            recipe[0, 2] = Item.ItemType.Default;     recipe[1, 2] = Item.ItemType.Default;     recipe[2, 2] = Item.ItemType.Default; 
            recipe[0, 1] = Item.ItemType.Default;     recipe[1, 1] = Item.ItemType.Wood;     recipe[2, 1] = Item.ItemType.Default; 
            recipe[0, 0] = Item.ItemType.Default;     recipe[1, 0] = Item.ItemType.Wood;     recipe[2, 0] = Item.ItemType.Default;
            recipeDictionary[Item.ItemType.Stick] = recipe;

            // Wooden Sword
            recipe = new Item.ItemType[GRID_SIZE, GRID_SIZE];
            recipe[0, 2] = Item.ItemType.Default;     recipe[1, 2] = Item.ItemType.Wood;      recipe[2, 2] = Item.ItemType.Default; 
            recipe[0, 1] = Item.ItemType.Default;     recipe[1, 1] = Item.ItemType.Wood;      recipe[2, 1] = Item.ItemType.Default; 
            recipe[0, 0] = Item.ItemType.Default;     recipe[1, 0] = Item.ItemType.Stick;     recipe[2, 0] = Item.ItemType.Default;
            recipeDictionary[Item.ItemType.Sword_Wood] = recipe;

            // Diamond Sword
            recipe = new Item.ItemType[GRID_SIZE, GRID_SIZE];
            recipe[0, 2] = Item.ItemType.Default;     recipe[1, 2] = Item.ItemType.Diamond;     recipe[2, 2] = Item.ItemType.Default; 
            recipe[0, 1] = Item.ItemType.Default;     recipe[1, 1] = Item.ItemType.Diamond;     recipe[2, 1] = Item.ItemType.Default; 
            recipe[0, 0] = Item.ItemType.Default;     recipe[1, 0] = Item.ItemType.Stick;       recipe[2, 0] = Item.ItemType.Default;
